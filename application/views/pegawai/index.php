    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('PegawaiController/createPegawai') ?>" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file"
                            class="form-control <?= $this->session->flashdata('error_foto') ? 'is-invalid' : ''; ?>"
                            name="foto" id="foto">
                        <div class="invalid-feedback">
                                ...
                                foreach ($pegawai as $pegawais): ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <?php if (!empty($pegawais['foto'])): ?>
                                                <img src="<?= base_url('assets/uploads/' . $pegawais['foto']) ?>"
                                                    alt="Foto Pegawai" width="100" height="100"
